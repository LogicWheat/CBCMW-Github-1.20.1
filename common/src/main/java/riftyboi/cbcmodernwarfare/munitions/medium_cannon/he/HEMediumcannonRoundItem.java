...
public class HEMediumcannonRoundItem extends MediumcannonRoundItem implements FuzedMediumItemMunition {

	public HEMediumcannonRoundItem(Properties properties) {
		super(properties);
	}

	@Override
	public AbstractMediumcannonProjectile getMediumcannonProjectile(ItemStack stack, Level level) {
		HEMediumcannonProjectile projectile = CBCModernWarfareEntityTypes.HE_ROUND.create(level);
	...
	public MediumcannonProjectilePropertiesComponent getMediumcannonProperties(ItemStack itemStack) {
		return CBCModernWarfareMunitionPropertiesHandlers.HE_MEDIUMCANNON.getPropertiesOf(this.getEntityType(itemStack)).mediumcannonProperties();
	}

	@Override
	public EntityType<?> getEntityType(ItemStack stack) {
		return CBCModernWarfareEntityTypes.HE_ROUND.get();
	}
	@Override public ItemStack getCartridgeType() { return CBCModernWarfareItem.HE_MEDIUMCANNON_CARTRIDGE.asStack(); }
}
