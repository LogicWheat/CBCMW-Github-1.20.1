...
public class APHEMediumcannonRoundItem extends MediumcannonRoundItem implements FuzedMediumItemMunition {

	public APHEMediumcannonRoundItem(Properties properties) {
		super(properties);
	}

	@Override
	public AbstractMediumcannonProjectile getMediumcannonProjectile(ItemStack stack, Level level) {
		APHEMediumcannonProjectile projectile = CBCModernWarfareEntityTypes.APHE_ROUND.create(level);
	...
	public MediumcannonProjectilePropertiesComponent getMediumcannonProperties(ItemStack itemStack) {
		return CBCModernWarfareMunitionPropertiesHandlers.APHE_MEDIUMCANNON.getPropertiesOf(this.getEntityType(itemStack)).mediumcannonProperties();
	}

	@Override
	public EntityType<?> getEntityType(ItemStack stack) {
		return CBCModernWarfareEntityTypes.APHE_ROUND.get();
	}
	@Override public ItemStack getCartridgeType() { return CBCModernWarfareItem.APHE_MEDIUMCANNON_CARTRIDGE.asStack(); }
}
