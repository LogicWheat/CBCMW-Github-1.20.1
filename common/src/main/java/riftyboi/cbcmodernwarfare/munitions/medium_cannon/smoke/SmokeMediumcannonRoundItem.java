...
public class SmokeMediumcannonRoundItem extends MediumcannonRoundItem implements FuzedMediumItemMunition {

	public SmokeMediumcannonRoundItem(Properties properties) {
		super(properties);
	}

	@Override
	public AbstractMediumcannonProjectile getMediumcannonProjectile(ItemStack stack, Level level) {
		SmokeMediumcannonProjectile projectile = CBCModernWarfareEntityTypes.SMOKE_ROUND.create(level);
	...
	@Override public ItemStack getCartridgeType() { return CBCModernWarfareItem.SMOKE_MEDIUMCANNON_CARTRIDGE.asStack(); }
}
