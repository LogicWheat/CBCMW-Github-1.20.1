...
public record RotarycannonMaterialProperties(int maxBarrelLength, float weight, float baseSpread, float spreadReductionPerBarrel,
											 ...
											 boolean isWeldable, int weldDamage, int weldStressPenalty, float roundPenDebuff) {

	public static RotarycannonMaterialProperties fromJson(JsonObject obj) {
		...
		float roundPenDebuff = Math.max(GsonHelper.getAsInt(obj, "round_pen_debuff", 0), 0);
		return new RotarycannonMaterialProperties(maxBarrelLength, weight, baseSpread, spreadReductionPerBarrel, baseSpeed,
			speedIncreasePerBarrel, maxSpeedIncreases, projectileLifetime, baseRecoil, connectsInSurvival, isWeldable,
			weldDamage, weldStressPenalty, roundPenDebuff);
	}
	...
	public JsonObject serialize() {
		...
		obj.addProperty("round_pen_debuff", this.roundPenDebuff);
		return obj;
	}
	...
	public void writeBuf(FriendlyByteBuf buf) {
		...
		buf.writeVarInt(this.weldDamage)
			.writeVarInt(this.weldStressPenalty).writeFloat(this.roundPenDebuff);
	}

	public static RotarycannonMaterialProperties fromBuf(FriendlyByteBuf buf) {
		...
		float roundPenDebuff = buf.readFloat();
		return new RotarycannonMaterialProperties(maxBarrelLength, weight, baseSpread, spreadReductionPerBarrel, baseSpeed,
			speedIncreasePerBarrel, maxSpeedIncreases, projectileLifetime, baseRecoil, connectsInSurvival, isWeldable,
			weldDamage, weldStressPenalty, roundPenDebuff);
	}
	...
	public static final class Builder {
		...
		public Builder roundPenDebuff(float roundPenDebuff) {
			this.roundPenDebuff = roundPenDebuff;
			return this;
		}
		public RotarycannonMaterialProperties build() {
			return new RotarycannonMaterialProperties(this.maxBarrelLength, this.weight, this.baseSpread,
				...
				this.isWeldable, this.weldDamage, this.weldStressPenalty, roundPenDebuff);
		}
	}
