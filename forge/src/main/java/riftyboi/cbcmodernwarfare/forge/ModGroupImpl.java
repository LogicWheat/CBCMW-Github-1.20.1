...
public class ModGroupImpl {
	...
	private static final DeferredRegister<CreativeModeTab> TAB_REGISTER = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CBCModernWarfare.MOD_ID);
	...
	public static void useModTab(ResourceKey<CreativeModeTab> key) {
		CBCModernWarfare.REGISTRATE.setCreativeTab(TABS.get(key));
	}
