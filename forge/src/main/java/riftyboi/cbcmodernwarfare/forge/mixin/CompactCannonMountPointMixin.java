...
public abstract class CompactCannonMountPointMixin extends ArmInteractionPoint {
	CompactCannonMountPointMixin(ArmInteractionPointType type, Level level, BlockPos pos, BlockState state) {
		super(type, level, pos, state);
	}

	@Override
	public ItemStack insert(ItemStack stack, boolean simulate) {
		CompactCannonMountPoint self = (CompactCannonMountPoint) (Object) this;
		if (!(this.level.getBlockEntity(this.pos) instanceof CompactCannonMountBlockEntity mount)) return stack;
