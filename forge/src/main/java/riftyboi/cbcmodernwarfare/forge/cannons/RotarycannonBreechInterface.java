...
public record RotarycannonBreechInterface(AbstractRotarycannonBreechBlockEntity breech) implements IItemHandler {
	@Override
	public int getSlots() {
		return 2;
	}
	...
	public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
		return stack.getItem() instanceof AutocannonAmmoItem && !(stack.getItem() instanceof FuzedItemMunition);
	}
}
